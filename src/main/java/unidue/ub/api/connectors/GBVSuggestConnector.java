...
public class GBVSuggestConnector {
 ...
 public GetMethod connection;
    ...
    static {
        ...
        API_URL = config.getString("MCR.api.gbv.Suggest");
    }
    
    public GBVSuggestConnector() {
    }
    
    public MCRContent getGND(PublicationAuthor author) throws JDOMException, IOException, SAXException {
        String query = API_URL + "?searchterm=" + author.getSurname() + " " + author.getFirstname() + "type=DifferentiatedPerson&count=10";
